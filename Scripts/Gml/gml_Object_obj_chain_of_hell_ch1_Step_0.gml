...
if (smashtime == 1)
{
    if (type == 0)
    {
        ...
        if (btimer == 10)
        {
            for (i = 0; i < 1; i += 1)
            {
                regbul = instance_create_ch1(__view_get(e__VW.XView, 0) + 320 + (i * 120), __view_get(e__VW.YView, 0) - 20, obj_regularbullet_ch1);
                regbul.vspeed = 2;
                regbul.gravity = 0.2;
        ...
        if (btimer >= 20)
        {
            ...
            for (i = 0; i < 2; i += 1)
            {
                regbul = instance_create_ch1(__view_get(e__VW.XView, 0) + 260 + (i * 120), __view_get(e__VW.YView, 0) - 20, obj_regularbullet_ch1);
                regbul.vspeed = 2;
                regbul.gravity = 0.2;
                regbul.sprite_index = spr_spadebullet_ch1;
                regbul.image_angle = 270;
