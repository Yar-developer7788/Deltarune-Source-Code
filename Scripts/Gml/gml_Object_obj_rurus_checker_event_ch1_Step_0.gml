...
if (con == 5)
{
    ...
    global.typer = 42;
    instance_create_ch1(__view_get(e__VW.XView, 0) + 120, 50, obj_writer_ch1);
    con = 6;
}

if (con == 6 && !instance_exists(obj_writer_ch1))
{
    appear = instance_create_ch1(__view_get(e__VW.XView, 0) + 420, __view_get(e__VW.YView, 0) + 160, obj_rurus_appear_ch1);
...
if (con == 20)
{
    ...
    snd_play_ch1(snd_rurus_appear_ch1);
    checkerappear = instance_create_ch1(__view_get(e__VW.XView, 0) + 380, __view_get(e__VW.YView, 0) + 120, obj_rurus_appear_ch1);
