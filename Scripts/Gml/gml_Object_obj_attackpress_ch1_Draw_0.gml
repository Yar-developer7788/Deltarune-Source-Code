...
if (active == 1)
{
    ...
    if (scr_monsterpop_ch1() > 0)
    {
        if (global.flag[13] == 1)
        {
            if (button1_p_ch1() && havechar[0] == 1)
                scr_boltcheck_ch1(0);
            
            if (button2_p_ch1() && havechar[1] == 1)
                scr_boltcheck_ch1(1);
            
            if (button3_p_ch1() && havechar[2] == 1)
                scr_boltcheck_ch1(2);
        }
    ...
    if (goahead == 1)
    {
        ...
        if (posttimer > (timermax - 35) && haveauto == 1 && autoed == 0 && scr_monsterpop_ch1() > 0)
        {
