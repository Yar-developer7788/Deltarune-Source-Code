...
if (type == 20 || type == 22)
{
    ...
    if (btimer >= bmax)
    {
        ...
        fallspade = instance_create_ch1(obj_heart_ch1.x + radius, __view_get(e__VW.YView, 0) - 20, obj_regularbullet_ch1);
...
if (type == 21 || type == 23 || type == 25)
{
    ...
    if (btimer >= bmax)
    {
        ...
        sidespade[side] = instance_create_ch1(__view_get(e__VW.XView, 0) + radius, (obj_growtangle_ch1.y - (obj_growtangle_ch1.sprite_height / 2)) + random(obj_growtangle_ch1.sprite_height), obj_regularbullet_ch1);
...
if (type == 85)
{
    if (made == 0)
    {
        ...
        fakesus = instance_create_ch1(__view_get(e__VW.XView, 0) + 530, obj_battlesolid_ch1.y - 40, obj_bulletparent_ch1);
    ...
    if (btimer >= 27 && instance_exists(obj_battlesolid_ch1) && global.turntimer > 10)
    {
        ...
        for (i = 0; i < 1; i += 1)
        {
            axe[i] = instance_create_ch1(__view_get(e__VW.XView, 0) + 540, obj_battlesolid_ch1.y, obj_axebullet_ch1);
...
if (joker == 1)
{
    ...
    if (type == 77)
    {
        ...
        if (special == 0)
        {
            ...
            amount = 0;
            jokertimer = 0;
            darkfader = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) - 10, spr_tallpx_ch1);
        ...
        if (realtimer == 20)
            instance_create_ch1(__view_get(e__VW.XView, 0) + 40, -60, obj_laserscythe_ch1);
        
        if (realtimer == 40)
            instance_create_ch1(__view_get(e__VW.XView, 0) + 570, -60, obj_laserscythe_ch1);
        ...
        if (realtimer >= 60 && amount < 30)
        {
            if (btimer >= rank)
            {
                ...
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 40 + (90 * which), -60, obj_laserscythe_ch1);
                
                if (which == 1)
                    scythe2 = instance_create_ch1(__view_get(e__VW.XView, 0) + 40 + 450, -60, obj_laserscythe_ch1);
                
                if (which == 0)
                    scythe2 = instance_create_ch1(__view_get(e__VW.XView, 0) + 40 + 540, -60, obj_laserscythe_ch1);
        ...
        {
            jokertimer = 0;
            jokerin = instance_create_ch1(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) + 100, obj_joker_teleport_ch1);
        ...
        if (special == 2)
        {
            ...
            {
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 40, -60, obj_laserscythe_ch1);
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 580, -60, obj_laserscythe_ch1);
            }
            
            if (jokertimer == 46 || jokertimer == 86)
            {
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 130, -60, obj_laserscythe_ch1);
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 490, -60, obj_laserscythe_ch1);
            }
            
            if (jokertimer == 52 || jokertimer == 80)
            {
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 220, -60, obj_laserscythe_ch1);
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 400, -60, obj_laserscythe_ch1);
            }
            
            if (jokertimer == 66 || jokertimer == 98)
                scythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 310, -60, obj_laserscythe_ch1);
            
            if (jokertimer == 130)
            {
                lastscythe = instance_create_ch1(__view_get(e__VW.XView, 0) + 320, -320, obj_laserscythe_ch1);
                p = 0;
                vol = 0;
                vol2 = 1;
                ...
                fadewhite = instance_create_ch1(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) - 40, obj_marker_ch1);
