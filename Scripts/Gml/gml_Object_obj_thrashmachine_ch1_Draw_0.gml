...
for (loop = 0; loop < 2; loop += 1)
{
    ...
    {
        if (part[2] == 0)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 0, (xx - (11 * s)) + (s * walka * 2), yy + (19 * s) + (s * walkb * 1), s / 2, s / 2, 0, color[2], a);
        
        if (part[2] == 1)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 1, (xx - (6 * s)) + (s * walka * 2), yy + (17 * s) + (s * walkb * 1), s / 2, s / 2, 0, color[2], a);
        
        if (part[2] == 3)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 4, (xx - (8 * s)) + (s * walka * 2), yy + (21 * s) + (s * walkb * 1), s / 2, s / 2, 0, color[2], a);
    }
}
...
if (part[0] >= 0)
{
    for (loop = 0; loop < 2; loop += 1)
    {
        ...
        if (bad == 1)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashbody_b"), part[0], xx, yy + (s * walkc), s / 2, s / 2, 0, color[0], a);
    }
}
...
for (loop = 0; loop < 2; loop += 1)
{
    ...
    {
        if (part[2] == 0)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 0, (xx - (5 * s)) + (s * walka * 2), yy + (20 * s) + (s * walkb * 1), s / 2, s / 2, 0, color[2], a);
        
        if (part[2] == 1)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 1, xx + (s * walka * 2), yy + (18 * s) + (s * walkb * 1), s / 2, s / 2, 0, color[2], a);
        
        if (part[2] == 2)
            draw_sprite_ext(scr_84_get_sprite_ch1("spr_thrashfoot_b"), 2, xx - (15 * s), yy + (18 * s), s / 2, s / 2, 0, color[2], a);
