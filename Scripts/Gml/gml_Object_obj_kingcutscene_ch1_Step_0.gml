if (con < 76)
{
    ...
    if (con == 53)
    {
        ...
        lspade = scr_marker_ch1(__view_get(e__VW.XView, 0) + 660, king.y + 60, spr_spadebullet_ch1);
...
if (con >= 150 && con < 250)
{
    ...
    if (con == 206 && !d_ex_ch1())
    {
        r = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) + 640, s.y + 10, spr_ralseil_ch1);
    ...
    if (con == 216 && !d_ex_ch1())
    {
        ...
        l = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) - 80, k.y, spr_lancer_rt_ch1);
...
if (con >= 250 && con <= 265)
{
    if (con == 250)
    {
        ...
        for (i = 0; i < xmake; i += 1)
        {
            for (j = 0; j < ymake; j += 1)
            {
                cwp[i][j] = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) - 180 - (i * 90), 230 + (j * 30), spr_crowdpiece_ch1);
        ...
        l = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) - 180 - 280, 60, spr_lancer_rt_ch1);
...
if (con >= 350 && con < 700)
{
    ...
    if (con == 353 && !d_ex_ch1())
    {
        ...
        scr_pan_ch1(3, 0, 60);
        r = scr_dark_marker_ch1(__view_get(e__VW.XView, 0) + 800, s.y + 10, spr_ralseil_ch1);
