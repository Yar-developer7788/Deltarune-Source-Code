...
for (var i = 0; i < 3; i += 1)
{
    ...
    if (global.char[i] == 2)
    {
        ...
        if (i > 0)
        {
            global.cinstance[i - 1] = instance_create_ch1(obj_mainchara_ch1.x - 6, obj_mainchara_ch1.y - 16, obj_caterpillarchara_ch1);
    ...
    if (global.char[i] == 3)
    {
        ...
        if (i > 0)
        {
            global.cinstance[i - 1] = instance_create_ch1(obj_mainchara_ch1.x - 4, obj_mainchara_ch1.y - 12, obj_caterpillarchara_ch1);
            global.cinstance[i - 1].target = i * 12;
