if (other.collided == 0)
{
    ...
    if (other.good == 1)
    {
        global.msg[0] = stringsetloc("* The wire was cut!/%", "obj_queen_ralseithrown_slash_Collision_22f849ff_cd13_405b_a486_5468f83d4033_gml_23_0");
        snd_play(snd_coin);
    ...
    else
    {
        ...
        global.msg[0] = stringsetloc("* The wire was cut!/%", "obj_queen_ralseithrown_slash_Collision_22f849ff_cd13_405b_a486_5468f83d4033_gml_42_0");
        hspeed = -12;
        vspeed = -4;
        gravity = 0.5;
        con = 2;
