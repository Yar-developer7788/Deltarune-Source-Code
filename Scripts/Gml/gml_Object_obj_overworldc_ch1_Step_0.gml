...
if (global.interact == 5)
{
    ...
    if (button1_p_ch1())
    {
        if (global.menuno == 5)
        {
            ...
            {
                global.menuno = 9;
                script_execute(scr_litemuseb_ch1, global.menucoord[1], global.litem[global.menucoord[1]]);
            }
            
            if (global.menucoord[5] == 1)
            {
                global.menuno = 9;
                script_execute(scr_litemdesc_ch1, global.litem[global.menucoord[1]]);
                script_execute(scr_writetext_ch1, 0, "x", 0, 0);
            }
            ...
            if (global.menucoord[5] == 2)
            {
                ...
                if (dontthrow == 1)
                {
                    if (dontthrowtype == 0)
                    {
                        ...
                        script_execute(scr_writetext_ch1, 10, "x", 0, 0);
                    }
        ...
        {
            global.menuno = 9;
            script_execute(scr_litemuseb_ch1, global.menucoord[3], global.phone[global.menucoord[3]]);
        }
        ...
        if (global.menuno == 3)
        {
            script_execute(scr_phonename_ch1);
...
if (global.menuno == 9 && instance_exists(obj_dialoguer_ch1) == false)
{
    global.menuno = -1;
    global.interact = 0;
}
