function scr_charbox_ch1()
{
    for (c = 0; c < 3; c += 1)
    {
        if (havechar[c] == 1)
        {
            ...
            {
                if (global.myfight == 0)
                    scr_selectionmatrix_ch1(xx + xchunk, (480 - bp) + yy);
            ...
            if (global.fighting == 1)
            {
                ...
                draw_sprite(scr_84_get_sprite_ch1("spr_btfight"), btc[0], xx + xchunk + 15, (485 - bp) + yy);
                
                if (c == 0)
                    draw_sprite(scr_84_get_sprite_ch1("spr_btact"), btc[1], xx + xchunk + 50, (485 - bp) + yy);
                else
                    draw_sprite(scr_84_get_sprite_ch1("spr_bttech"), btc[1], xx + xchunk + 50, (485 - bp) + yy);
                
                draw_sprite(scr_84_get_sprite_ch1("spr_btitem"), btc[2], xx + xchunk + 85, (485 - bp) + yy);
                draw_sprite(scr_84_get_sprite_ch1("spr_btspare"), btc[3], xx + xchunk + 120, (485 - bp) + yy);
                draw_sprite(scr_84_get_sprite_ch1("spr_btdefend"), btc[4], xx + xchunk + 155, (485 - bp) + yy);
                
                if (spare_glow == 1 && gc == charpos[c])
                    draw_sprite_ext(scr_84_get_sprite_ch1("spr_btspare"), 2, xx + xchunk + 120, (485 - bp) + yy, 1, 1, 0, c_white, 0.4 + (sin(global.time / 6) * 0.4));
                
                if (pacify_glow == 1 && gc == charpos[c])
                    draw_sprite_ext(scr_84_get_sprite_ch1("spr_bttech"), 2, xx + xchunk + 50, (485 - bp) + yy, 1, 1, 0, c_white, 0.4 + (sin(global.time / 6) * 0.4));
            }
            ...
            if (c == 0)
            {
                ...
                draw_sprite(scr_84_get_sprite_ch1("spr_bnamekris"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            if (c == 1)
            {
                draw_sprite(spr_headsusie_ch1, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite_ch1("spr_bnamesusie"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            if (c == 2)
            {
                draw_sprite(spr_headralsei_ch1, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite_ch1("spr_bnameralsei"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
