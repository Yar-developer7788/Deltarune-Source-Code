...
.localvar 126 slot_size 4719
.localvar 11922 json 4720

:[0]
b [10]

> gml_Script_ossafe_savedata_save_ch1 (locals=2, argc=0)
:[1]
...
:[10]
push.i [function]gml_Script_ossafe_savedata_save_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_savedata_save_ch1
popz.v
