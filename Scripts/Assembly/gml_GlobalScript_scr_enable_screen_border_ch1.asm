...
.localvar 262 flag 4750

:[0]
b [4]

> gml_Script_scr_enable_screen_border_ch1 (locals=1, argc=1)
:[1]
...
:[4]
push.i [function]gml_Script_scr_enable_screen_border_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_enable_screen_border_ch1
popz.v
