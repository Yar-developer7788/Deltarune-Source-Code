...
> gml_Script_scr_nextmsg (locals=0, argc=0)
:[1]
push.v self.msgno
pushi.e 1
add.i.v
...
pushi.e 0
pop.v.i self.miniface_pos
pushi.e -1
pop.v.i self.miniface_current_pos
pushi.e -1
push.v self.msgno
conv.v.i
...
:[4]
push.i [function]gml_Script_scr_nextmsg
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_nextmsg
popz.v
