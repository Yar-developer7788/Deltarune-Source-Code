...
.localvar 126 slot_size 3594

:[0]
b [10]

> gml_Script_ossafe_savedata_load (locals=1, argc=0)
:[1]
...
:[10]
push.i [function]gml_Script_ossafe_savedata_load
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_savedata_load
popz.v
