...
.localvar 126 slot_size 70

:[0]
b [10]

> gml_Script_ossafe_savedata_load_old_check (locals=1, argc=0)
:[1]
...
:[10]
push.i [function]gml_Script_ossafe_savedata_load_old_check
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_savedata_load_old_check
popz.v
