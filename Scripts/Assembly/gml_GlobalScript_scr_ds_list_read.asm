...
.localvar 11960 new_list 3637
.localvar 11962 list_string 3638

:[0]
b [5]

> gml_Script_scr_ds_list_read (locals=2, argc=1)
:[1]
...
:[5]
push.i [function]gml_Script_scr_ds_list_read
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_ds_list_read
popz.v
