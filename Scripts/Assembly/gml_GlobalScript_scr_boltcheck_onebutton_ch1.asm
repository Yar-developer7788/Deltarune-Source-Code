...
> gml_Script_scr_boltcheck_onebutton_ch1 (locals=0, argc=0)
:[1]
pushi.e -1
...
:[45]
push.i [function]gml_Script_scr_boltcheck_onebutton_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_boltcheck_onebutton_ch1
popz.v
