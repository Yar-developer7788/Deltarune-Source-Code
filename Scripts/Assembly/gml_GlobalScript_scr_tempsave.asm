...
.localvar 173 is_valid 1822
.localvar 9635 error_message 1823

:[0]
b [6]

> gml_Script_scr_tempsave (locals=2, argc=0)
:[1]
...
:[6]
push.i [function]gml_Script_scr_tempsave
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_tempsave
popz.v
