...
.localvar 3439 name 4714
.localvar 6278 file 4715
.localvar 147 data 4716

:[0]
b [8]

> gml_Script_ossafe_ini_open_ch1 (locals=3, argc=1)
:[1]
...
:[8]
push.i [function]gml_Script_ossafe_ini_open_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_ini_open_ch1
popz.v
