...
.localvar 11960 new_list 4770
.localvar 107 i 4771
.localvar 11962 list_string 4772

:[0]
b [5]

> gml_Script_scr_ds_list_write_ch1 (locals=3, argc=2)
:[1]
...
:[5]
push.i [function]gml_Script_scr_ds_list_write_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_ds_list_write_ch1
popz.v
