...
.localvar 3439 name 3534
.localvar 6278 file 3535
.localvar 147 data 3536
.localvar 148 num_lines 3537
.localvar 152 newline_pos 3538
.localvar 153 nextline_pos 3539
.localvar 156 line 3540
.localvar 159 lines 3541

:[0]
b [25]

> gml_Script_ossafe_file_text_open_read (locals=8, argc=1)
:[1]
...
:[25]
push.i [function]gml_Script_ossafe_file_text_open_read
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_open_read
popz.v
