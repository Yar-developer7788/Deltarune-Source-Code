...
pushi.e 0
pop.v.i self.hspeed
push.v self.spr_checkers_crouch
...
push.v self.spr_checkershrapnel
push.v self.shrap
pushi.e -9
...
:[53]
push.v self.spr_checkers_magnificent
pop.v.v self.sprite_index
push.d 0.5
pop.v.d self.image_speed
pushi.e 1
