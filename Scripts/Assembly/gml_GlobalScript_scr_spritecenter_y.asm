...
.localvar 11830 _spriteCenterLen 3480
.localvar 11831 _spriteCenterDir 3481

:[0]
b [3]

> gml_Script_scr_spritecenter_y (locals=2, argc=1)
:[1]
...
:[3]
push.i [function]gml_Script_scr_spritecenter_y
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_spritecenter_y
popz.v
