...
.localvar 11884 handle 3553
.localvar 156 line 3554

:[0]
b [10]

> gml_Script_ossafe_file_text_read_string (locals=2, argc=1)
:[1]
...
:[10]
push.i [function]gml_Script_ossafe_file_text_read_string
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_read_string
popz.v
