...
.localvar 9214 _sprite_xoffset 1577
.localvar 9215 _sprite_yoffset 1578
.localvar 9174 _sprite_width 1579
.localvar 9175 _sprite_height 1580
.localvar 9205 _true_xanchor 1581
.localvar 9206 _true_yanchor 1582
.localvar 9208 _leftcrop 1583
.localvar 9209 _topcrop 1584
.localvar 9210 _rightcrop 1585
.localvar 9211 _bottomcrop 1586

:[0]
b [9]

> gml_Script_scr_draw_sprite_crop (locals=10, argc=8)
:[1]
...
:[9]
push.i [function]gml_Script_scr_draw_sprite_crop
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_draw_sprite_crop
popz.v
