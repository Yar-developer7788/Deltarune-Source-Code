...
.localvar 11885 filename 3695
.localvar 12038 file_buffer 3696
.localvar 11922 json 3697

:[0]
b [6]

> gml_Script_scr_84_load_map_json (locals=3, argc=1)
:[1]
...
:[6]
push.i [function]gml_Script_scr_84_load_map_json
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_84_load_map_json
popz.v
