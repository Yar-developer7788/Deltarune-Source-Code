...
conv.s.v
push.s "* Hey^1, Kris^1.&* There's someone up there waving at us./"@15554
conv.s.v
...
conv.s.v
push.s "* Any idea what they want...?/%"@15556
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 1
