...
.localvar 173 is_valid 4662
.localvar 11884 handle 4663

:[0]
b [8]

> gml_Script_ossafe_file_text_close_ch1 (locals=2, argc=1)
:[1]
pushi.e 1
...
:[8]
push.i [function]gml_Script_ossafe_file_text_close_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_close_ch1
popz.v
