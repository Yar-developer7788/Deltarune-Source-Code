...
.localvar 11078 __depth 3019
.localvar 11155 __tiles 3021
.localvar 11156 __currtile 3022
.localvar 11157 __layers 3023
.localvar 11158 __numlayers 3025
.localvar 6565 __i 3026
.localvar 11028 __els 3027
.localvar 11159 __numels 3028
.localvar 6374 __j 3029
.localvar 11160 __eltype 3030

:[0]
b [13]

> gml_Script_tile_get_ids_at_depth (locals=10, argc=1)
:[1]
...
:[13]
push.i [function]gml_Script_tile_get_ids_at_depth
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.tile_get_ids_at_depth
popz.v
