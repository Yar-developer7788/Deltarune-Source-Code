...
.localvar 11884 handle 4690
.localvar 156 line 4691

:[0]
b [8]

> gml_Script_ossafe_file_text_readln_ch1 (locals=2, argc=1)
:[1]
...
:[8]
push.i [function]gml_Script_ossafe_file_text_readln_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_readln_ch1
popz.v
