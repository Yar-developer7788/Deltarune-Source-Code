...
.localvar 720 len 2059
.localvar 107 i 2060
.localvar 721 args 2061
.localvar 730 msg_index 2062
.localvar 737 format_string 2063
.localvar 738 localized_format_string_id 2064
.localvar 723 str 2065

:[0]
b [7]

> gml_Script_c_msgsetsubloc (locals=7, argc=0)
:[1]
...
:[7]
push.i [function]gml_Script_c_msgsetsubloc
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.c_msgsetsubloc
popz.v
