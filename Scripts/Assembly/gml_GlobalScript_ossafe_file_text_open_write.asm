...
.localvar 11884 handle 3545

:[0]
b [6]

> gml_Script_ossafe_file_text_open_write (locals=1, argc=1)
:[1]
...
:[6]
push.i [function]gml_Script_ossafe_file_text_open_write
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_open_write
popz.v
