...
.localvar 11884 handle 3548
.localvar 156 line 3549

:[0]
b [10]

> gml_Script_ossafe_file_text_read_real (locals=2, argc=1)
:[1]
...
:[10]
push.i [function]gml_Script_ossafe_file_text_read_real
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.ossafe_file_text_read_real
popz.v
