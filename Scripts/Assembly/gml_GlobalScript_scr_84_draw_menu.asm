...
.localvar 11973 array 3650
.localvar 6482 xx 3651
.localvar 6483 yy 3652
.localvar 11974 vspacing 3653
.localvar 11975 selection_indices 3654
.localvar 11976 func_depth 3656
.localvar 11977 menu_depth 3657
.localvar 755 length 3658
.localvar 107 i 3659
.localvar 6235 ndx 3660
.localvar 4672 type 3661
.localvar 229 item 3662
.localvar 3439 name 3663
.localvar 11978 selected 3664
.localvar 11980 prefix 3665

:[0]
b [18]

> gml_Script_scr_84_draw_menu (locals=15, argc=7)
:[1]
...
call.i gml_Script_scr_84_draw_menu(argc=7)
pop.v.v local.yy
...
:[18]
push.i [function]gml_Script_scr_84_draw_menu
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_84_draw_menu
popz.v
