...
push.i 166594
setowner.e
push.s "obj_shop_ch2_swatch_slash_Create_0_gml_80_0"@28509
conv.s.v
push.s "ITEM#Short for#ButlerJuice#+100HP"@28510
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 0
pop.v.v [array]self.shopdesc
push.s "obj_shop_ch2_swatch_slash_Create_0_gml_79_0"@28511
conv.s.v
push.s "ITEM#Spaghetti#woven by#master coders#Party +30HP"@28512
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 1
pop.v.v [array]self.shopdesc
push.s "obj_shop_ch2_swatch_slash_Create_0_gml_81_0"@28513
conv.s.v
push.s "ARMOR#A handsome#bowtie."@28514
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 2
pop.v.v [array]self.shopdesc
push.s "obj_shop_ch2_swatch_slash_Create_0_gml_81_0_b"@28515
conv.s.v
push.s "ARMOR#Luxurious#brooch."@28516
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 3
