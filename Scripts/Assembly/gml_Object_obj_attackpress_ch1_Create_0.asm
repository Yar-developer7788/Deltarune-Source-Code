...
push.v self.i
conv.v.i
push.v [arraypopaf]self.boltframe
push.v self.c
conv.v.i
popaf.e
push.v self.i
...
push.v self.i
conv.v.i
push.v [arraypushaf]self.boltframe
pushi.e 2
pushaf.e
pushi.e -1
push.v self.i
