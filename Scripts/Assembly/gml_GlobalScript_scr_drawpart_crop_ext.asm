...
.localvar 9205 _true_xanchor 1602
.localvar 9206 _true_yanchor 1603
.localvar 9208 _leftcrop 1604
.localvar 9209 _topcrop 1605
.localvar 9210 _rightcrop 1606
.localvar 9211 _bottomcrop 1607

:[0]
b [9]

> gml_Script_scr_drawpart_crop_ext (locals=6, argc=4)
:[1]
push.v self.x
...
:[9]
push.i [function]gml_Script_scr_drawpart_crop_ext
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_drawpart_crop_ext
popz.v
