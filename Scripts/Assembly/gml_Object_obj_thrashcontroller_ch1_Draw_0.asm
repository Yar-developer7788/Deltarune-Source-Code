...
call.i draw_set_alpha(argc=1)
popz.v
push.s "obj_thrashcontroller_slash_Draw_0_gml_39_0"@38882
conv.s.v
...
call.i draw_set_alpha(argc=1)
popz.v
push.s "obj_thrashcontroller_slash_Draw_0_gml_41_0"@38883
conv.s.v
call.i gml_Script_scr_84_get_lang_string_ch1(argc=1)
call.i string_hash_to_newline(argc=1)
push.v self.yy
...
push.v self.j
conv.v.i
push.v [arraypushaf]self.menutext1
push.v self.i
conv.v.i
pushaf.e
call.i string_hash_to_newline(argc=1)
...
sub.i.v
conv.v.i
push.v [arraypushaf]self.assetdesc
pushi.e -5
pushi.e 216
push.v self.menu
add.v.i
...
sub.i.v
conv.v.i
push.v [arraypushaf]self.menutext2
push.v self.i
conv.v.i
pushaf.e
call.i string_hash_to_newline(argc=1)
...
:[93]
push.s "obj_thrashcontroller_slash_Draw_0_gml_155_0"@38888
conv.s.v
call.i gml_Script_scr_84_get_lang_string_ch1(argc=1)
...
:[98]
push.s "obj_thrashcontroller_slash_Draw_0_gml_158_0"@38890
conv.s.v
call.i gml_Script_scr_84_get_lang_string_ch1(argc=1)
pop.v.v self.endtext
...
:[101]
push.s "obj_thrashcontroller_slash_Draw_0_gml_171_0"@38891
conv.s.v
call.i gml_Script_scr_84_get_lang_string_ch1(argc=1)
call.i string_hash_to_newline(argc=1)
push.v self.yy
...
call.i draw_set_color(argc=1)
popz.v
push.s "obj_thrashcontroller_slash_Draw_0_gml_180_0"@38892
conv.s.v
call.i gml_Script_scr_84_get_lang_string_ch1(argc=1)
call.i string_hash_to_newline(argc=1)
push.v self.yy
