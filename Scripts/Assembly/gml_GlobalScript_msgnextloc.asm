...
.localvar 723 str 338
.localvar 731 localized_string_id 339

:[0]
b [4]

> gml_Script_msgnextloc (locals=2, argc=2)
:[1]
...
:[4]
push.i [function]gml_Script_msgnextloc
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.msgnextloc
popz.v
