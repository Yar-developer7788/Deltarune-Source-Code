...
push.i 166594
setowner.e
push.s "obj_shop2_slash_Create_0_gml_73_0"@28216
conv.s.v
push.s "ITEM#Fragrant#sauce#heals 50HP"@28217
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 0
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_74_0"@28218
conv.s.v
push.s "WEAPON#Heroic &#Cool"@28219
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 1
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_75_0"@28220
conv.s.v
push.s "WEAPON#Homemade#Healing up"@28221
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -1
pushi.e 2
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_76_0"@28222
conv.s.v
