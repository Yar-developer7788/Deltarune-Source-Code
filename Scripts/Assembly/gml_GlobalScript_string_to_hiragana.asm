...
.localvar 723 str 3749
.localvar 10706 result 3750
.localvar 12130 lastch 3751
.localvar 107 i 3752
.localvar 12131 ch 3753
.localvar 12133 halfkata 3754
.localvar 12135 daku_from 3755
.localvar 12137 daku_to 3756
.localvar 773 pos 3757
.localvar 12139 handaku_from 3758
.localvar 12141 handaku_to 3759

:[0]
b [23]

> gml_Script_string_to_hiragana (locals=11, argc=1)
:[1]
...
:[23]
push.i [function]gml_Script_string_to_hiragana
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.string_to_hiragana
popz.v
