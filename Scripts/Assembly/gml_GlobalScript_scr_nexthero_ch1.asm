...
> gml_Script_scr_nexthero_ch1 (locals=0, argc=0)
:[1]
pushi.e 0
...
pushi.e 1
conv.i.v
call.i gml_Script_scr_charcan_ch1(argc=1)
conv.v.b
b [5]
...
:[35]
push.i [function]gml_Script_scr_nexthero_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_nexthero_ch1
popz.v
