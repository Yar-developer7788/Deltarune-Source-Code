...
.localvar 9424 _control 4387
.localvar 9434 left_bracket 4388
.localvar 9436 right_bracket 4389

:[0]
b [25]

> gml_Script_scr_get_input_name_ch1 (locals=3, argc=1)
:[1]
push.s "[?]"@9423
...
:[25]
push.i [function]gml_Script_scr_get_input_name_ch1
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_get_input_name_ch1
popz.v
