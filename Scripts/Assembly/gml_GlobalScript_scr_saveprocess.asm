...
.localvar 9698 stats_amount 1894
.localvar 173 is_valid 1895

:[0]
b [42]

> gml_Script_scr_saveprocess (locals=2, argc=1)
:[1]
...
call.i gml_Script_ossafe_file_text_write_string(argc=2)
popz.v
push.v self.myfileid
call.i gml_Script_ossafe_file_text_writeln(argc=1)
popz.v
...
call.i gml_Script_scr_ds_list_write(argc=2)
popz.v
push.v self.myfileid
call.i gml_Script_ossafe_file_text_writeln(argc=1)
popz.v
...
push.v self.myfileid
call.i gml_Script_ossafe_file_text_write_real(argc=2)
popz.v
push.v self.myfileid
call.i gml_Script_ossafe_file_text_writeln(argc=1)
popz.v
...
:[7]
pushi.e 5
pop.v.i local.stats_amount
pushloc.v local.stats_amount
pushglb.v global.hp
call.i gml_Script_scr_ds_list_write(argc=2)
popz.v
push.v self.myfileid
...
:[42]
push.i [function]gml_Script_scr_saveprocess
conv.i.v
pushi.e -1
conv.i.v
...
dup.v 0
pushi.e -1
pop.v.v [stacktop]self.scr_saveprocess
popz.v
