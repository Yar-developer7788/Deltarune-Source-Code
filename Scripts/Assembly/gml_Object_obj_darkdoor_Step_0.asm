...
conv.s.v
push.s "* Well^1, here's the closet^1.&* Too bad.../"@14931
conv.s.v
...
conv.s.v
push.s "\\E2* We were just starting to have fun./%"@14933
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 1
...
conv.s.v
push.s "* Hey^1, Kris^1, is it me^1, or.../"@14937
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 1
...
conv.s.v
push.s "\\E6* Is it REALLY dark in there?/%"@14939
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 2
...
conv.s.v
push.s "\\E6* What's the holdup^1, Kris^1?&* Are you gonna go in or what?/%"@14941
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "\\E7* Fine^1!&* If you're gonna be a WIMP^1, then I'll.../%"@14943
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "\\E7* We'll both go in at the same time!!/%"@14945
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "* Man^1, the sun's already setting.../"@14948
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "\\E3* Everyone else must have gone home by now./%"@14950
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 1
...
conv.s.v
push.s "\\E2* Guess Alphys'll know better than to ask US next time^1, huh?/%"@14952
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "\\E1* Well^1, guess we should go./"@14956
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
...
conv.s.v
push.s "\\E1* See ya later^1, I guess./%"@14959
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 2
...
conv.s.v
push.s "\\E8* Let's go back there tomorrow, alright?/%"@14965
conv.s.v
call.i gml_Script_stringsetloc(argc=2)
pushi.e -5
pushi.e 0
